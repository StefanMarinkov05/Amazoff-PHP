...
**See the whole app without running it locally** — [`demo/README.md`](demo/README.md)
is a full screenshot walkthrough of every storefront and admin-panel page,
across all four roles, with the architecture and business rules behind
each action explained alongside the screenshots.
