...
<div>
    ...
    <section class="relative overflow-hidden bg-ink-950">
        ...
        <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            <p class="text-xs font-semibold uppercase tracking-[0.2em] text-brand-orange">Amazoff</p>
            ...
            <a href="/catalogue" wire:navigate
               class="mt-8 inline-flex items-center gap-2 rounded-control bg-white px-5 py-2.5 text-sm font-semibold
