...
| Info | Informational | http://webserver | Percentage of responses with status code 2xx | 80 % |
| Info | Informational | http://webserver | Percentage of responses with status code 3xx | 1 % |
| Info | Informational | http://webserver | Percentage of responses with status code 4xx | 19 % |
...
| Info | Informational | http://webserver | Percentage of endpoints with method GET | 99 % |
| Info | Informational | http://webserver | Percentage of endpoints with method POST | 1 % |
| Info | Informational | http://webserver | Count of total endpoints | 469    |
| Info | Informational | http://webserver | Percentage of slow responses | 78 % |
...
| Session Management Response Identified | Informational | 455 |
...
* URL: http://webserver:80/catalogue
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `<script type="module" src="http://localhost:5173/@vite/client" data-navigate-track="reload"></script>`
  * Other Info: ``
...
* URL: http://webserver/admin/article-categories/1/edit
  ...
  * Attack: ``
  * Evidence: ``
  * Other Info: `Location header URI length: 22 [http://webserver/login].
Predicted response size: 322.
Response Body Length: 334.`
* URL: http://webserver/admin/logout
  * Node Name: `http://webserver/admin/logout ()(_token)`
  * Method: `POST`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
  * Other Info: `Location header URI length: 22 [http://webserver/admin].
Predicted response size: 322.
Response Body Length: 334.`
...
* URL: http://webserver/about
  ...
  * Method: `GET`
  * Parameter: `http://localhost:5173/@vite/client`
  * Attack: ``
  * Evidence: `<script type="module" src="http://localhost:5173/@vite/client" data-navigate-track="reload"></script>`
  * Other Info: ``
* URL: http://webserver:80/catalogue
...
* URL: http://webserver:80/catalogue
  * Node Name: `http://webserver/catalogue`
  * Method: `GET`
  * Parameter: `http://localhost:5173/resources/js/app.js`
  * Attack: ``
  * Evidence: `<script type="module" src="http://localhost:5173/resources/js/app.js" data-navigate-track="reload"></script>`
  * Other Info: ``
...
* URL: http://webserver/admin/contact-messages
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/16
  * Node Name: `http://webserver/admin/contact-messages/16`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/16/edit
  * Node Name: `http://webserver/admin/contact-messages/16/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/17
  * Node Name: `http://webserver/admin/contact-messages/17`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/17/edit
  * Node Name: `http://webserver/admin/contact-messages/17/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/18
  * Node Name: `http://webserver/admin/contact-messages/18`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/18/edit
  * Node Name: `http://webserver/admin/contact-messages/18/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/19
  * Node Name: `http://webserver/admin/contact-messages/19`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/19/edit
  * Node Name: `http://webserver/admin/contact-messages/19/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/20
  * Node Name: `http://webserver/admin/contact-messages/20`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/20/edit
  * Node Name: `http://webserver/admin/contact-messages/20/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/21
  * Node Name: `http://webserver/admin/contact-messages/21`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/21/edit
  * Node Name: `http://webserver/admin/contact-messages/21/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/22
  * Node Name: `http://webserver/admin/contact-messages/22`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/contact-messages/22/edit
  * Node Name: `http://webserver/admin/contact-messages/22/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/inventories/157
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/inventories/160
  * Node Name: `http://webserver/admin/inventories/160`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/inventories/19
  * Node Name: `http://webserver/admin/inventories/19`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/newsletter-subscribers
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/19
  * Node Name: `http://webserver/admin/newsletter-subscribers/19`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/19/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/19/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/21
  * Node Name: `http://webserver/admin/newsletter-subscribers/21`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/21/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/21/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/25
  * Node Name: `http://webserver/admin/newsletter-subscribers/25`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/25/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/25/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/29
  * Node Name: `http://webserver/admin/newsletter-subscribers/29`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/29/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/29/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/31
  * Node Name: `http://webserver/admin/newsletter-subscribers/31`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/31/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/31/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/newsletter-subscribers/36/edit
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/40
  * Node Name: `http://webserver/admin/newsletter-subscribers/40`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/40/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/40/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/46
  * Node Name: `http://webserver/admin/newsletter-subscribers/46`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/46/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/46/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/newsletter-subscribers/76/edit
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/77
  * Node Name: `http://webserver/admin/newsletter-subscribers/77`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/newsletter-subscribers/77/edit
  * Node Name: `http://webserver/admin/newsletter-subscribers/77/edit`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/orders
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/11
  * Node Name: `http://webserver/admin/orders/11`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/110
  * Node Name: `http://webserver/admin/orders/110`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/118
  * Node Name: `http://webserver/admin/orders/118`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/125
  * Node Name: `http://webserver/admin/orders/125`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/25
  * Node Name: `http://webserver/admin/orders/25`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/35
  * Node Name: `http://webserver/admin/orders/35`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/44
  * Node Name: `http://webserver/admin/orders/44`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/63
  * Node Name: `http://webserver/admin/orders/63`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/65
  * Node Name: `http://webserver/admin/orders/65`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/orders/92
  * Node Name: `http://webserver/admin/orders/92`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/payments
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/120
  * Node Name: `http://webserver/admin/payments/120`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/18
  * Node Name: `http://webserver/admin/payments/18`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/payments/23
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/36
  * Node Name: `http://webserver/admin/payments/36`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/51
  * Node Name: `http://webserver/admin/payments/51`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/53
  * Node Name: `http://webserver/admin/payments/53`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/8
  * Node Name: `http://webserver/admin/payments/8`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/83
  * Node Name: `http://webserver/admin/payments/83`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/90
  * Node Name: `http://webserver/admin/payments/90`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/payments/96
  * Node Name: `http://webserver/admin/payments/96`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/product-reviews
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/11
  * Node Name: `http://webserver/admin/product-reviews/11`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/12
  * Node Name: `http://webserver/admin/product-reviews/12`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/13
  * Node Name: `http://webserver/admin/product-reviews/13`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/2
  * Node Name: `http://webserver/admin/product-reviews/2`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/33
  * Node Name: `http://webserver/admin/product-reviews/33`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/38
  * Node Name: `http://webserver/admin/product-reviews/38`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/45
  * Node Name: `http://webserver/admin/product-reviews/45`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/59
  * Node Name: `http://webserver/admin/product-reviews/59`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/product-reviews/62
  * Node Name: `http://webserver/admin/product-reviews/62`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/shipments
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/14
  * Node Name: `http://webserver/admin/shipments/14`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/19
  * Node Name: `http://webserver/admin/shipments/19`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/31
  * Node Name: `http://webserver/admin/shipments/31`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/37
  * Node Name: `http://webserver/admin/shipments/37`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/admin/shipments/6
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/63
  * Node Name: `http://webserver/admin/shipments/63`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/69
  * Node Name: `http://webserver/admin/shipments/69`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/73
  * Node Name: `http://webserver/admin/shipments/73`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/85
  * Node Name: `http://webserver/admin/shipments/85`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/admin/shipments/88
  * Node Name: `http://webserver/admin/shipments/88`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver:80/catalogue
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/catalogue%3FattributeValueIds%255B0%255D=27&category=clothing-women-tops-hoodies
...
* URL: http://webserver/catalogue%3FsortBy=created_at&sortDir=desc
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout
  * Node Name: `http://webserver/checkout`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/151
  * Node Name: `http://webserver/checkout/confirmation/151`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/152
  * Node Name: `http://webserver/checkout/confirmation/152`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/153
  * Node Name: `http://webserver/checkout/confirmation/153`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/154
  * Node Name: `http://webserver/checkout/confirmation/154`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/155
  * Node Name: `http://webserver/checkout/confirmation/155`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/156
  * Node Name: `http://webserver/checkout/confirmation/156`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/157
  * Node Name: `http://webserver/checkout/confirmation/157`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/158
  * Node Name: `http://webserver/checkout/confirmation/158`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/159
  * Node Name: `http://webserver/checkout/confirmation/159`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/checkout/confirmation/160
  * Node Name: `http://webserver/checkout/confirmation/160`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/journal
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/journal%3FcategoryId=1
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/journal%3Ftag=home
...
* URL: http://webserver/products/cargo-shorts-utility-pockets-clm0008
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/products/cashmere-blend-v-neck-sweater-clw0004
  * Node Name: `http://webserver/products/cashmere-blend-v-neck-sweater-clw0004`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/products/classic-crew-neck-t-shirt-clm0001
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/products/classic-fitted-t-shirt-clw0001
  * Node Name: `http://webserver/products/classic-fitted-t-shirt-clw0001`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/products/countertop-microwave-25l-kit0006
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/products/cropped-zip-up-hoodie-clw0005
  * Node Name: `http://webserver/products/cropped-zip-up-hoodie-clw0005`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/products/random-orbital-sander-5-inch-pwr0007
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/products/ribbed-tank-top-clw0003
  * Node Name: `http://webserver/products/ribbed-tank-top-clw0003`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
...
* URL: http://webserver/products/screwdriver-set-6pc-magnetic-hnd0005
  ...
  * Other Info: `cookie:amazoff-session
cookie:XSRF-TOKEN`
* URL: http://webserver/products/silk-blend-blouse-long-sleeve-clw0002
  * Node Name: `http://webserver/products/silk-blend-blouse-long-sleeve-clw0002`
  * Method: `GET`
  * Parameter: `amazoff-session`
  * Attack: ``
  * Evidence: `amazoff-session`
